  ...
  return (
    <>
      ...
      {navIsOpen && (
        <aside
          id="default-sidebar"
          className={`  rounded w-full sm:h-full h-screen xl:h-screen transition-all duration-200 `}
          aria-label="Sidebar text-textColor "
        >
          <div className="h-full    py-4 overflow-y-auto   pt-32 px-10 bg-gray-50  dark:bg-[#1E1E1E] dark:text-white">
            <p
              className={`${
                pathName === `/${params.locale}/dashboard`
                  ? "text-mainColor"
                  : "dart:text-white  "
              }  font-medium text-h5 my-5 `}
            >
              {t("General")}
            </p>
